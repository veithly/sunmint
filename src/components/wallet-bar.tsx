...
// Lit-based web component — must mount client-only (it registers a custom element
// against `window.customElements` on module evaluation).
  ...
  return (
    <div className="ml-2 flex items-center gap-2">
      <div
        title={
          isConnected
            ? `Signing as your wallet ${account!.address}`
            : status?.demo.configured
